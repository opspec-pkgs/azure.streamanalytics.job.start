[![Build Status](https://travis-ci.org/opspec-pkgs/azure.streamanalytics.job.start.svg?branch=master)](https://travis-ci.org/opspec-pkgs/azure.streamanalytics.job.start)
